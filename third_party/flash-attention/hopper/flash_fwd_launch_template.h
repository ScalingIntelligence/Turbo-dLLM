...
template <int Arch, int kHeadDim, int kHeadDimV, int ClusterM, typename Element, typename ElementOut,
          ...
          bool PackGQA, bool Split, bool V_colmajor, bool Is_dflash>
void run_flash_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    using CollectiveMainloop = std::conditional_t<
        Arch >= 90,
        flash::CollectiveMainloopFwdSm90<kStages, ClusterShape, TileShape_MNK, kHeadDimV, Element, float, cutlass::arch::Sm90, Is_causal, Is_local, Has_softcap, Varlen, PagedKVNonTMA, AppendKV, HasQv, MmaPV_is_RS, IntraWGOverlap, PackGQA, Split, V_colmajor, false, Is_dflash>,
        flash::CollectiveMainloopFwdSm80<kNWarps, kStages, Q_in_regs, TileShape_MNK, kHeadDimV, Element, float, cutlass::arch::Sm80, Is_causal, Is_local, Has_softcap, Varlen, PagedKVNonTMA, AppendKV, PackGQA, Split, Is_dflash>
    >;
    ...
    CAUSAL_LOCAL_SWITCH(params.is_causal, params.is_local, Is_causal, Is_local, [&] {
        VCOLMAJOR_SWITCH(params.v_dim_stride != 1, V_colmajor_, [&] {
            ...
            VARLEN_SWITCH(params.cu_seqlens_q || params.cu_seqlens_k || params.seqused_q || params.seqused_k || params.leftpad_k, Varlen, [&] {
                ...
                bool const has_structured_mask = params.bdlm_query_blocks_ptr != nullptr
                    || params.dflash_context_starts_ptr != nullptr;
                BOOL_SWITCH(params.qv_ptr, HasQV_, [&] {
                    ...
                    APPENDKV_SWITCH(params.knew_ptr, AppendKV, [&] {
                        ...
                        CLUSTER_SWITCH(!has_structured_mask && cutlass::ceil_div(params.seqlen_q * (!PackGQA ? 1 : params.h / params.h_k), kBlockM) % 2 == 0, Use_cluster, [&] {
                            static constexpr int ClusterM = Enable_cluster && Use_cluster ? 2 : 1;
                            BOOL_SWITCH(params.dflash_context_starts_ptr != nullptr, Is_dflash, [&] {
                                run_flash_fwd<Arch, kHeadDim, kHeadDimV, ClusterM, T, T_out, Is_causal, Is_local, Has_softcap, Varlen, PagedKVNonTMA, AppendKV && Varlen, HasQv, PackGQA, Split, V_colmajor, Is_dflash>(params, stream);
                            });
                        });
                    });
                });
